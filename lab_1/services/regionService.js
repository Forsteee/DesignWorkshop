...
module.exports = () => {
    return {
        getRegion: (numberRegion) => {
            var reg = new Map([
                ['01', 'Республика Адыгея'],
                ['02', 'Республика Башкортостан'], ['102', 'Республика Башкортостан'],
                ['03', 'Республика Бурятия'], ['103', 'Республика Бурятия'],
                ['04', 'Республика Алтай (Горный Алтай)'], ['05', 'Республика Дагестан'],
                ['06', 'Республика Ингушетия'], ['07', 'Кабардино-Балкарская Республика'],
                ['08', 'Республика Калмыкия'], ['09', 'Республика Карачаево-Черкессия'],
                ['10', 'Республика Карелия'], ['11', 'Республика Коми'],
                ['12', 'Республика Марий Эл'], ['13', 'Республика Мордовия'],
                ['113', 'Республика Мордовия'], ['14', 'Республика Саха (Якутия)'],
                ['15', 'Республика Северная Осетия — Алания'], ['16', 'Республика Татарстан'],
                ['116', 'Республика Татарстан'], ['17', 'Республика Тыва'],
                ...
                ['93', 'Краснодарский край'], ['123', 'Краснодарский край'],
                ['24', 'Красноярский край'], ['84', 'Красноярский край'],
                ['88', 'Красноярский край'], ['124', 'Красноярский край'],
                ...
                ['134', 'Волгоградская область'], ['35', 'Вологодская область'],
                ['36', 'Воронежская область'], ['136', 'Воронежская область'],
                ['37', 'Ивановская область'], ['38', 'Иркутская область'],
                ['85', 'Иркутская область'], ['138', 'Иркутская область'],
                ...
                ['50', 'Московская область'], ['90', 'Московская область'],
                ['150', 'Московская область'], ['190', 'Московская область'],
                ['750', 'Московская область'], ['51', 'Мурманская область'],
                ['52', 'Нижегородская область'], ['152', 'Нижегородская область'],
                ['53', 'Новгородская область'], ['54', 'Новосибирская область'],
                ['154', 'Новосибирская область'], ['55', 'Омская область'],
                ['56', 'Оренбургская область'], ['57', 'Орловская область'],
                ['58', 'Пензенская область'], ['59', 'Пермский край'],
                ['81', 'Пермский край'], ['159', 'Пермский край'],
                ['60', 'Псковская область'], ['61', 'Ростовская область'],
                ['161', 'Ростовская область'], ['62', 'Рязанская область'],
                ...
                ['96', 'Свердловская область'], ['196', 'Свердловская область'],
                ...
                ['97', 'г. Москва'], ['99', 'г. Москва'],
                ['177', 'г. Москва'], ['197', 'г. Москва'],
                ['199', 'г. Москва'], ['777', 'г. Москва'],
                ['799', 'г. Москва'], ['78', 'г. Санкт-Петербург'],
                ['98', 'г. Санкт-Петербург'], ['178', 'г. Санкт-Петербург'],
                ['79', 'Еврейская автономная область'], ['82', 'Республика Крым'],
                ['83', 'Ненецкий автономный округ'], ['86', 'Ханты-Мансийский автономный округ — Югра'],
                ['186', 'Ханты-Мансийский автономный округ — Югра'], ['87', 'Чукотский автономный округ'],
                ['89', 'Ямало-Ненецкий автономный округ'], ['92', 'г. Севастополь'],
                ['94', 'Территории, находящиеся за пределами РФ и обслуживаемые Департаментом режимных объектов МВД Росси'], ['95', 'Чеченская республика'],
            ]);

            if(reg.has(numberRegion))
            {
                return reg.get(numberRegion);
            }else{return "Такого региона нет"};
        },
    }
};